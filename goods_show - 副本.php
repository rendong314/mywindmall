...
<section>
  ...
  <div class="pro_xqy_con"><span class="fl">优惠：<?php if($r['songhuo']=='true'){echo GetFragment(8);}else{ echo "暂无优惠";}?></span> <span class="fr">销量：<?php echo $r['monthsell'];?></span>   <span class="fr lqb_zan" style=" margin-right:5%;-webkit-tap-highlight-color:transparent;" onClick="zan(<?php echo $id;?>,<?php
