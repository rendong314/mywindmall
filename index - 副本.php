<?php require_once(dirname(__FILE__).'/include/config.inc.php'); 
    ...
    $agent = $_SERVER['HTTP_USER_AGENT'];
     if(strpos($agent,"icroMessenger")){
        ...
        if(!$info){
            $code = $weObj->getOauthRedirect('http://'.$_SERVER['HTTP_HOST'],'','snsapi_base');
            header("Location: $code");
        }
     
        if(isset($info['openid'])){ 
			$r_user = $dosql->GetOne("SELECT * FROM `#@__member` WHERE openid='".$info['openid']."'");
            $wxuser = json_decode($r_user['wx_info'],true);
            setcookie('username',AuthCode($r_user['id'],'ENCODE'), time()+3600*24000*24000*24000*24000*24000*24000*24000*24000*24000);
        }
    } 
?>
<!DOCTYPE html >
...
<div style="background:#f1f1f1 ;padding:5% 0 0 0;">
	<div class="search_bor" style="border:none; background:#FFF;">
		...
		<input type="text" name="keyword" class="fl search_inp ss_bd" placeholder="商品搜索：请输入商品关键字" value="<?php if(isset($keyword)){echo $keyword;} ?>" style=" background:#FFF;">
		</form> 
		<div class="cl"></div>
	</div>
</div>
...
<section style="background:#f1f1f1">
	<ul class="index_list tc">
		<li><a href="goods_type.php"><img src="images/index_07.png" alt=""><br>商品分类</a></li>
		...
		<li><a href="member.php?c=favorite"><img src="images/index_11.png" alt=""><br>我的收藏</a></li>
		<div class="cl"></div>
	</ul>
...
<?php }?>	
	...
	<div class="dztj_bor">
		...
		<div class="fr dztj_r">
			...
			<a href="goods_list.php?flag=z&cgx=sy"><div class="hsh_tit font_16"><span class="fl xpss_tit_icon"><img src="images/index_33.jpg" alt="" style="width:25px; height:19px;"></span><sapn class="fl">惠生活</sapn><div class="cl"></div></div>
