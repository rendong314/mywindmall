...
if(isset($action) and $action=='add')
{
	...
	{*/
		...
		$sql = "INSERT INTO `#@__message` (siteid, nickname, contact, content, orderid, posttime, htop, rtop, checkinfo, ip, fankui) VALUES (".$uid.", '$lc_name', '$lc_tel', '$lc_content', '', '$posttime', '', '', 'false', '$ip', '1')";
		//echo $sql;die;
