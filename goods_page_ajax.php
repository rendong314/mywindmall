...
$cgx = isset($_POST['cgx'])?$_POST['cgx']:"";//获取新闻所属分类
...
if($rs!=0){
    ...
    <li><a href="goods_show.php?id=<?php echo $rows['id'];?>&cid=<?php echo $rows["typeid"]?>"><img src="<?php echo $rows['picurl'];?>" alt="" height="150">
		<div style="height:40px;"><?php echo mb_substr($rows['title'],0,30,'utf-8');?></div></a>
        <span class="fl"><font class="jptj_red font_14">￥<?php echo $rows['salesprice'];?></font></span> <span class="fr main_pro_list_icon"><img src="images/a05.png" alt="" onClick="cart_list(<?php echo $rows['id'];?>,<?php echo $rows['typeid'];?>)" style="width:25px; height:25px;"></span> <?php if($row['integral']!='0'){?><span class="jptj_jf tr">积 分</span><?php }?><div class="cl"></div></li>
		<?php
