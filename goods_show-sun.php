...
<section>
  ...
  <div class="pro_xqy_con"><span class="fl">优惠：<?php echo GetFragment(8);?></span> <span class="fr">销量：<?php echo $r['monthsell'];?></span>   <span class="fr" style=" margin-right:5%;-webkit-tap-highlight-color:transparent;" onClick="zan()">
...
<script>
	function zan(){
		$.post("Ajax_dianzan.php",{a:'zanadd',goodsid:<?php echo $id?>,uid:<?php echo $c_uname?>},function(data){
			if(data==1){
				//alert('成功点赞！')
				...
				return false;
					...
					return false;
						...
						$.post("Ajax_dianzan.php",{a:'delzan',goodsid:<?php echo $id?>,uid:<?php echo $c_uname?>},function(data){
							if(data==5){
...
<footer>
  ...
  <ul class="pro_xqy_bot tc">
    <li class="pro_xqy_bot_icon01 fl" style="margin-left:2%;"><a href="goodscar.php"><img src="images/a13.jpg" alt=""></a></li>
    <li class="pro_xqy_bot_icon01 fl" style="margin-left:2%;"><a href="member.php?c=default"><img src="images/a14.jpg" alt=""></a></li>
