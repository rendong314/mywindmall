...
<!--代金券 END--> 
 ...
 <!--     <div class="ddy_djq"><span class="fl">总优惠</span><font class="red fr">￥<span class="hyj">0</span></font>
      ...
      <div class="ddy_djq"><span class="fl">邮费</span><span class="fr"><font class="red">￥<span class="peisongfei"><?php if($ps_jiage >= GetFragment(14)){echo "0";}else{ echo GetFragment(9);}?>
        </span></font></span>
        <div class="cl"></div>
      </div>
...
?>
        <li class="addre"><br>
          ...
          <p><?php //echo $row_add['province'].'&nbsp;'.$row_add['city'].'&nbsp;'.$row_add['country'].'&nbsp;'.$row_add['address'];
		  echo $row_add['address'];?>(<?php echo $row_add['code'] ?>)</p>
          <br>
          </span>
          <ul class="tc biji">
...
?>
  <div class="ddy_add_fixed2 bianji<?php echo $row_bianji['id'];?>">
    ...
    <!--  <li><span class="fl">黑龙江省、哈尔滨市、双城区</span>-->
        <input type="hidden" id="Select1" class="grey_9 ddy_add_inp province<?php echo $row_bianji['id'];?>" name="province" value="陕西省">
        <input type="hidden" id="Select2" class="grey_9 ddy_add_inp city<?php echo $row_bianji['id'];?>" name="city" value="西安市">
        <input type="hidden" id="Select3" class="grey_9 ddy_add_inp country<?php echo $row_bianji['id'];?>" name="county" value="雁塔区">
    <!--   <span class="fr ddy_add_icon"><img src="images/a39.png" alt=""></span></a><div class="cl"></div></li>-->
      <li>
      ...
      <div class="grey_bg"></div>
      <li><span class="fl">设为默认收货地址2</span>
